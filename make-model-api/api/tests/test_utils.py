...
class TestUtils(TestCase):
    """
    Tests if the file format is acceptable and if the file was properly
    hashed
    """

    def test_allowed_file(self):
        """
        Checks if the file format is the right one
        """
    ...
    def test_get_file_hash(self):
        ...
        """
        filename = "tests/ford_ranger.jpg"
        md5_filename = "2412f56b22c6aba4d7f0470a3a0a1a02.jpg"
