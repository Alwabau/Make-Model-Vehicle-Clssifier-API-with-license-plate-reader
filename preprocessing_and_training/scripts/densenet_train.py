'''
This script will be used for training our DenseNet CNN. This model is the last
classification between all the 836 make/model classes. The only input argument it
should receive is the path to our configuration file in which we define all
the experiment settings like dataset, model output folder, epochs, learning rate, 
...
def main(config_file):
    ...
    # Creates a Densenet121 model for finetuning
    cnn_model = densenet121_model.create_model(**config["model"])
